...
from src.titration.runTitrationCurve import writeTitrationDatas
...
for outDir, initFile, convertFile, speciesFile, reacFile \
    ...
    weight1 = 1
    weight2 = 100
    prob = CalcComplex(myIon, myReac, myConc, epsilon, weight1, weight2)

    writeTitrationDatas(prob, outDir, vali=True)
